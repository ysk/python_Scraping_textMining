...
#LINE BOT
LINE_NOTIFY_API_KEY = os.environ['LINE_NOTIFY_API_KEY']
...
#占い結果を出す西暦と星座を質問する
input_year   = input('西暦を指定してください\n\n')
input_Period = input('上半期・下半期を選択してください\n\n上半期 : 1\n下半期 : 2\n\n')
input_sign   = input('星座を選択してください\n\n牡羊座 : 1\n牡牛座 : 2\n双子座 : 3\n蟹　座 : 4\n獅子座 : 5\n乙女座 : 6\n天秤座 : 7\n蠍　座 : 8\n射手座 : 9\n山羊座 : 10\n水瓶座 : 11\n魚　座 : 12\n\n')
...
def selectSign():
    ...
    #URL生成    
    baseUrl = "https://voguegirl.jp/horoscope/shiitake{}-h{}/contents/".format(input_year, input_Period)
    print(periodDict[input_Period])
...
def sendLineBot():
    ...
    message = input_year+ "年" + periodDict[input_Period]+ "。" + signDict[input_sign] + "の占い結果を圧縮しました！"
